...
void SceneGame::Init()
{
	...
	// KHI: Load WaterBalloon animation clips
	texIds.push_back("assets/item/bubble.png");
	texIds.push_back("assets/item/damage.png");
	...
	// LMJ: Load Sound Buffers
	soundIds.push_back("sounds/Blow_WaterBomb.mp3");
	soundIds.push_back("sounds/Boomhill.mp3");
	soundIds.push_back("sounds/Bubble_Sound.wav");
	soundIds.push_back("sounds/Eat_Item.mp3");
	soundIds.push_back("sounds/Game_Start.mp3");
	soundIds.push_back("sounds/Kill_WaterBomb.wav");
	soundIds.push_back("sounds/Lobby.wav");
